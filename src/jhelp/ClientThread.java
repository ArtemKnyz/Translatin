...
public class ClientThread implements JHelp, Runnable {
    ...
    public void run() {
        try {
            ...
            System.err.println("CT : Class Error in run:GetData call ->" + ex.getMessage());
        } catch (IOException ex) {
            System.err.println("CT : IO Error in run:GetData call ->" + ex.getMessage());
        }
    ...
    public int connect(String[] args) {
        try {
            ...
            System.err.println("CT : Error in creating connections " + ex.getMessage());
            return JHelp.ERROR;
        }
    ...
    public int disconnect() {
        try {
            ...
            System.err.println("CT error on closing connetction->" + ex.getMessage());
        }
